...
@Component({
  selector: 'app-lista-tiposala-selection',
  templateUrl: './lista-tiposala-selection.component.html',
  styleUrls: ['./lista-tiposala-selection.component.css']
})
export class ListaTiposalaSelectionComponent implements OnInit {
